...
class Inc_Browser {
    ...
    */
    ...
    public function isMobileDevice() {
        // always get update from http://detectmobilebrowsers.com/
    ...
    public static function isValidSessionId ($token) {
        $browser = new Inc_Browser();
        // because ie cannot create new session
    ...
    public static function validSessionId ($token) {
        if (Inc_Browser::isValidSessionId($token) === FALSE) {
            ?>
